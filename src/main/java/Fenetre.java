...
public class Fenetre extends JFrame implements MouseListener {
	...
	RequeteSQL bimbamboum = new RequeteSQL();
	...
	Object[][] data = {
			{bimbamboum.getBDD("SELECT Symbole FROM Entreprises"), sd.getName(), sd.getPrix_action("YHOO"), 0,
	...
	public static void main(String[] args) {
		    Connexion conn = new Connexion("BDD.sqlite");
		    java.sql.Date maDatedeNaissance = null; 
		    conn.connect();
		    conn.setBDD("Intl", "Intel", (float) 27.5 ,12 ,maDatedeNaissance.valueOf("1995-12-25"));
		   // System.out.println(maDatedeNaissance.toLocalDate().toString());
		    new Fenetre();
		    conn.close();
